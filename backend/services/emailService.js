...
export const sendPasswordResetEmail = async (userEmail, resetToken, userType) => {
    try {
        // For development, log token to console if email not configured
        if (!process.env.EMAIL_USER || !process.env.EMAIL_PASSWORD) {
            ...
            console.log('==========================================\n');
            return { success: true, message: 'Reset token logged to console (email not configured)' };
        }
        ...
        const mailOptions = {
            ...
            to: userEmail,
            subject: 'Password Reset Request - Medicard',
            html: `
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="warning">
                                <strong>⚠️ Important:</strong> This link will expire in 1 hour. If you didn't request a password reset, please ignore this email or contact support.
                            </div>
                            
                            <p>If you have any issues, please contact support.</p>
                            
                            <p>Best regards,<br><strong>Medicard Team</strong></p>
                        </div>
                        <div class="footer">
                            <p>This is an automated message. Please do not reply to this email.</p>
                            <p>&copy; ${new Date().getFullYear()} Medicard. All rights reserved.</p>
