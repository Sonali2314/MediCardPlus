      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-bold">Healthcare Platform</h2>
            <p className="mt-2 text-sm text-gray-300">
              Secure, intelligent healthcare records at your fingertips
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3 md:gap-12">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <a href="mailto:support@healthcare-platform.com" className="text-sm text-gray-300 hover:text-white">
                    Email Support
                  </a>
                </li>
                <li>
